    ...
    try {
      ...
      if (response.ok) {
        ...
        if (signinResponse.ok) {
          ...
          localStorage.setItem('user', JSON.stringify(signinData.user || { username: formData.username }))
          navigate('/dashboard')
        } else {
      ...
      >
        ...
        <div className="glass-effect p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-white/70">Create your account and start exploring</p>
          </div>
                ...
                <div className="grid grid-cols-4 gap-3">
                  {avatars.slice(0, 8).map((avatar) => (
                    ...
                    >
                      ...
                      />
                      <p className="text-xs text-white/70 mt-1 truncate">{avatar.name}</p>
                    </button>
                  ))}
                </div>
              </div>
