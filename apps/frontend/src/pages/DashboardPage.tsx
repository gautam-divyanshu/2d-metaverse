  ...
  const fetchPublicSpaces = async () => {
    try {
      const response = await fetch(
        'http://localhost:3000/api/v1/space/public',
        {
          headers: {
        ...
        {activeTab === 'join-spaces' ? (
          <div>
            ...
            <div className="mb-6">
              ...
              <p className="text-slate-400">
                Join spaces created by other users
              </p>
            </div>
            ...
            {publicSpaces.length === 0 ? (
              <div className="text-center py-12 bg-slate-800 rounded-xl border border-slate-700">
                ...
                <p className="text-slate-400">
                  Be the first to create a space that others can join!
                </p>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {publicSpaces.map((space) => (
                  <div
                    key={space.id}
                    className="bg-slate-800 rounded-xl border border-slate-700 hover:shadow-lg transition-shadow"
                  >
            ...
            {isLoading ? (
              ...
              <div className="text-center py-12 bg-slate-800 rounded-xl border border-slate-700">
                ...
                <p className="text-slate-400 mb-6">
                  Create your first map template to get started
                </p>
                <button
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <p className="text-slate-400">
                Explore map templates created by other users
              </p>
            </div>
            ...
            {publicMaps.length === 0 ? (
              <div className="text-center py-12 bg-slate-800 rounded-xl border border-slate-700">
                ...
                <p className="text-slate-400">
                  Be the first to create a map template that others can explore!
                </p>
                {user?.role === 'admin' && (
                  <button
                    onClick={() => navigate('/admin')}
